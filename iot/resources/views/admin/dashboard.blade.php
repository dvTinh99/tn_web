...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
                <div class="card-header">
                    <h4 class="card-title">Light (Lux)</h4>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                        <div class="wapper">
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h4 class="card-title">Turbidity (V)</h4>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                        <div class="wapper">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card  card-tasks">
                ...
                <div class="card-body" style="position: relative;margin-bottom:-333px">
                  <div class="loader" id="loader">
                      <img src="{{  asset('assets/img/loading.gif') }}" alt="Loading ...">
                  </div>
                    <div class="wapper" style="position: relative; z-index:1;top:-330px">
            ...
            $(document).ready(function() {
                ...
                const callAPI = async (sensor) => {
                    const response = await fetch(
                        'https://microalgae-api.herokuapp.com/algae_biomass_prediction', {
                            method: 'POST',
                            headers: {
